...
public class Level5Scene extends JPanel implements LevelScene {
    ...
    private String gameMessage = "Selamat datang di Level 5!";
    private String timerText   = "05:00";

    public Level5Scene(GameController ctrl) {
        this.ctrl = ctrl;
        setLayout(null);
        loadImages();
        buildButtons();
    ...
    private void loadImages() {
        try {
            foodImage = new ImageIcon(getClass().getResource("/background/level5.png")).getImage();
