...
public class Level3Scene extends JPanel implements LevelScene {
    ...
    private String gameMessage = "Selamat datang di Level 3!";
    private String timerText   = "05:00";

    public Level3Scene(GameController ctrl) {
        this.ctrl = ctrl;
        setLayout(null);
        loadImages();
        buildButtons();
    ...
    private void loadImages() {
        try {
            foodImage = new ImageIcon(getClass().getResource("/background/level3.PNG")).getImage();
    ...
    private void buildButtons() {
        String[] menuImages = { "/menu/kopi.png", "/menu/nasiayam.png", "/menu/kentanggoreng.png" };
